    ...
    const fetchListing = async () => {
        try {
            ...
            if (docSnap.exists()) {
                ...
                setFormData({...docSnap.data(), latitude: docSnap.data().geolocation.lat, longitude: docSnap.data().geolocation.lng, address: docSnap.data().location})
                setLoading(false);
            } else {
                navigate('/')
...
// Sets useRef to logged in user's uid 
  useEffect(() => {
    if (isMounted) {
  ...
  const onSubmit = async (e) => {
    ...
    !formDataCopy.offer && (formDataCopy.discountedPrice)
